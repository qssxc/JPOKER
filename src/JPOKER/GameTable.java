	...
	private void initialize() {
		...
		btnDeck.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				gamePhase = "Betting";
				if(money<100) {JOptionPane.showMessageDialog(frame, "기본금 지급"); money = 10000;}
		...
		btnBetting.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				gamePhase = "gameend";
				if(!txfBetting.getText().matches("[0-9]+"))				JOptionPane.showMessageDialog(frame, "정수만 입력할수있습니다.");
				
				else if(Integer.parseInt(txfBetting.getText())<100) 	JOptionPane.showMessageDialog(frame, "최소베팅액은 100입니다");
				
				else if(Integer.parseInt(txfBetting.getText())>money) 	JOptionPane.showMessageDialog(frame, "보유금액보다 많이베팅할 수 없습니다");
